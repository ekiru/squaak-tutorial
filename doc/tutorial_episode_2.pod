...
will print this parse tree (without the line numbers):
 ...
 1 "parse" => PMC 'Regex;Match' => "say \"Squaak!\";\n" @ 0 {
 2    <statementlist> => PMC 'Regex;Match' => "say \"Squaak!\";\n" @ 0 {
 3        <statement> => ResizablePMCArray (size:1) [
 4            PMC 'Regex;Match' => "say \"Squaak!\"" @ 0 {
 5                <statement_control> => PMC 'Regex;Match' => "say \"Squaak!\"" @ 0 {
 6                    <sym> => PMC 'Regex;Match' => "say" @ 0
 7                    <EXPR> => ResizablePMCArray (size:1) [
 8                        PMC 'Regex;Match' => "\"Squaak!\"" @ 4 {
 9                            <quote> => PMC 'Regex;Match' => "\"Squaak!\"" @ 4 {
10                                <quote_EXPR> => PMC 'Regex;Match' => "\"Squaak!\"" @ 4 {
11                                    <quote_delimited> => PMC 'Regex;Match' => "\"Squaak!\"" @ 4 {
12                                        <stopper> => PMC 'Regex;Match' => "\"" @ 12
13                                        <starter> => PMC 'Regex;Match' => "\"" @ 4
14                                        <quote_atom> => ResizablePMCArray (size:1) [
15                                            PMC 'Regex;Match' => "Squaak!" @ 5
16                                        ]
17                                    }
18                                }
19                            }
